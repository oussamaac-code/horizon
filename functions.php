...
function load_scripts(){
    ...
    wp_enqueue_style( 'swiper', get_template_directory_uri() . '/asset/css/swiper-bundle.min.css',false,'0.1','all');
    wp_enqueue_style( 'toastifycss', get_template_directory_uri() . '/asset/css/toastify.css',false,'0.1','all');
    ...
    wp_enqueue_script( 'swiperjs', get_template_directory_uri() . '/asset/js/swiper-bundle.min.js', false, '0.0', true); 
    wp_enqueue_script( 'toastify', get_template_directory_uri() . '/asset/js/toastify.js', false, '0.0', true);
...
// ** header
get_template_part('inc/header/mini-cart');
get_template_part('inc/header/login');
get_template_part('inc/header/search');


// ** customizer api 
get_template_part('inc/custom/blog',);
get_template_part('inc/custom/header');
get_template_part('inc/custom/footer');
